...
else
{
	...
	if(isset($_POST['submit']))
	{
		...
		$sql=mysqli_query($mysqli,"UPDATE products SET pimage2='$productimage2' where pid='$pid'");
					...
					<div class="content">
						<div class="module">
							...
							<div class="module-body">
								...
								<?php 
								$pid=$_GET['id'];
								$query=mysqli_query($mysqli,"SELECT pname,pimage2 FROM products WHERE pid='$pid'");
								...
								?>
									...
									<div class="control-group">
										<label class="control-label" for="basicinput">Current Product Image2</label>
											<div class="controls">
												<img src="productimages/<?php echo $pid;?>/<?php echo $row['pimage2'];?>" width="200" height="100"> 
											</div>
									</div>
									<div class="control-group">
